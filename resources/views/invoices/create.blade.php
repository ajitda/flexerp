    ...
    <div class="container" ng-app="automateApp">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h1>Make Invoice<a href="{{route('invoices.index')}}" class="btn btn-primary pull-right"><i class="fa fa-list"></i>&nbsp; List </a></h1>
            </div>
            <div class="panel-body" ng-controller="automateController">
                <div class="row">
                    ...
                    <div class="form-group col-md-4">
                        <label for="qty">Enter Amount</label>
                        {!! Form::number('amount', null, array('required', 'id'=>'amount', 'class'=>'form-control', 'placeholder'=>'', 'ng-model'=>'qty')) !!}
                    </div>
                    <div class="form-group col-md-4">
