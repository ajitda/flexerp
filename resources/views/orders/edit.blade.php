            ...
            <div class="panel-body" ng-controller="automateController">
                <div class="row">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        {!! Form::select('type', array('cheque'=>'Cheque', 'bkash'=>'Bkash', 'cash'=>'Cash', 'online'=> 'Online', 'pending'=>'Pending'), null, array('required', 'class'=> 'form-control', 'id'=> 'type', 'placeholder'=>'Payment Type')) !!}
                    </div>
                    <div class="form-group col-md-3">
