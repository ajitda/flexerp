    ...
    <div class="container">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h1>Reports/Payments List<a href="reports/create" class="pull-right btn btn-primary"><span class="glyphicon glyphicon-plus"></span>&nbsp; Create</a></h1>
            </div>
                ...
                <table class="table table-striped table-hover">
                    ...
                    @foreach($reports as $report)
                        <tr>
                            ...
                            <td>{{$report->dues}}</td>
                            <td><a href="reports/{{$report->id}}/show">{{$report->employee->name}}</a></td>
                            <td><a href="reports/{{$report->id}}/show">
                                    @if(isset($report->customer_id))
                                        {{$report->customer->name}}
                                    @endif
                                </a></td>
                            <td width="100"><a href="reports/{{$report->id}}/show">
                                    @if(isset($report->reference_id))
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        <li><a href="reports/{{$report->id}}/edit"><i class="fa fa-pencil"></i> Edit</a></li>
                                        <li><a href="#" data-toggle="modal" data-target="#myModal{{$report->id}}"><i class="fa fa-dollar"></i> Payment</a></li>

                                        <li><a href="#" class="delete-form" onclick="return confirm('are you sure?')">
                                                <i class="fa fa-trash-o"></i> {!! Form::open(['method'=> 'DELETE', 'route'=>['reports.destroy', $report->id], 'class'=>'form-inline']) !!}
                                        ...
                                        <div class="modal-dialog modal-sm">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    {!! Form::open(['route'=>'reportpayment.store']) !!}
                                                    <div class="form-group">
